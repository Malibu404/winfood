...
const products = [
    {
        image: "https://uploads.onecompiler.io/438a5mq9w/43xjbfs33/Mohinga%2060g%20copy.jpg",
        title: "Ready to Cook Mohinga",
        description: "Authentic Myanmar mohinga ready to cook - the nation's most beloved noodle soup.",
        fullDescription: "Our Ready to Cook Mohinga brings Myanmar's national dish to your kitchen with authentic flavors and traditional preparation methods. This beloved fish-based noodle soup is enriched with lemongrass, ginger, and aromatic spices, served with rice noodles and fresh herbs. Simply heat and enjoy the taste of Myanmar's culinary heritage, recommended by MasterChef Myanmar U Sharky.",
        ingredients: ["Fish Stock", "Rice Noodles", "Lemongrass", "Ginger", "Traditional Myanmar Spices", "Fish Paste", "Banana Stem", "Onions"],
        nutritionFacts: {
    ...
    {
        image: "https://uploads.onecompiler.io/438a5mq9w/43xjbfs33/Ambarella%20Fish%20Paste%20Curry.png",
        title: "Ambarella Fish Paste Curry",
        description: "Ready to eat ambarella fish paste curry - a tangy and flavorful traditional Myanmar dish.",
        fullDescription: "Our Ambarella Fish Paste Curry combines the unique tangy flavor of ambarella fruit with rich fish paste to create an authentic Myanmar curry experience. This ready-to-eat dish captures the perfect balance of sour, savory, and spicy flavors that Myanmar cuisine is famous for. Every meal is a taste of home, crafted with traditional recipes and premium ingredients.",
        ingredients: ["Fresh Ambarella", "Premium Fish Paste", "Traditional Curry Spices", "Coconut Oil", "Onions", "Garlic", "Chili", "Tamarind"],
        nutritionFacts: {
...
function updateCarousel() {
    ...
    document.getElementById('current-product-title').textContent = currentProduct.title;
    document.getElementById('current-product-description').textContent = currentProduct.description;
    ...
    document.getElementById('back-product-title').textContent = currentProduct.title;
...
function addScrollAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.product-card, .section-header, .contact-card, .about-image, .about-text');
